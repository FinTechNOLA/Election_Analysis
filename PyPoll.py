...
total_votes = 0
# Initialize the candidate name options
candidate_options = []
# Declare the  candidate votes variable
candidate_votes = {}
...
with open(file_to_save, "w") as txt_file:
    # Print the finale vote count to the terminal.
    election_results = (
        f"\nElection Results\n"
        f"------------------------\n"
    ...
    for candidate_name in candidate_votes:
        ...
        if (votes > winning_count) and (vote_percentage > winning_percentage):
            # If true then set winning_count = vote and winning_percent =
            # vote_percentage.
            winning_count = votes
            winning_percentage = vote_percentage
            # Set the winning_candidate equat to the candidate's name.
